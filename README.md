...
- **ETL Engine:** Automated download, zero-copy Parquet compilation, integrity validation using **DuckDB**.
...
2. **Full Stochastic Sampling:**
   ...
   - **Random Timeframe Resampling:** Reshaped candles between 1 minute and 8 hours.
